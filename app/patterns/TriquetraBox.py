...
def generate_TriquetraBox(arm_length, poi_length, num_points, start_side='left', rotation_direction='clockwise'):
    petals = 4  # For 3 visible antispin petals
    ...
    # Double the phase offset for 3-petal box
    phase_offset = -np.pi - 2 * np.pi / 4
