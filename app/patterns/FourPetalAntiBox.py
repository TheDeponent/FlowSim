...
def generate_FourPetalAntiBox(arm_length, poi_length, num_points, start_side='left', rotation_direction='clockwise'):
    ...
    theta_2 = np.linspace(-np.pi, -rotation_direction_multiplier * petals * np.pi - np.pi, num_points)
